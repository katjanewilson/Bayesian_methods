...
```{r E4}
data = data.frame(machine = c(2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L), outcome = c("L", "W", "L", "L", "W", "L", "L", "L", "W", "L", "W", "W", "W", "W", "W", "L", "L", "L", "L", "L", "L", "W", "L", "L", "W", "L", "W", "W", "L", "W", "L"))
bandit_posterior(data = data)
```
...
```{r E5}
data = data.frame(machine = c(2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "L", "W", "W", "W", "L", "W", "L", "W", "L", "W", "L", "W", "L", "L", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "W", "L", "W", "L", "L", "L", "L", "L", "L", "L", "L", "L", "L", "W", "L", "L", "L", "W", "L", "L", "L", "W", "L", "W", "L"))
